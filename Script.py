import os
class script(object):
    START_TXT = """<b>ʜᴇʏ {}, {}\n\nɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴄᴏʀɴ ʙᴏᴛ 😍\n<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/TEAM_COLD">𝚃𝙴𝙰𝙼 𝙲𝙾𝙻𝙳</a></blockquote></b>"""
...
ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "🎗️ ᴊᴏɪɴ ɴᴏᴡ 🎗️" ʙᴜᴛᴛᴏɴ ᴀɴᴅ ᴄʟɪᴄᴋ "Request to Join Channel" ʙᴜᴛᴛᴏɴ, ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴛʜᴇ "♻️ ᴛʀʏ ᴀɢᴀɪɴ ♻️" ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ꜰɪʟᴇꜱ.

താങ്കൾ ആവശ്യപ്പെട്ട ഫയൽ ലഭിക്കുന്നതിനായി താഴെക്കാണുന്ന "🎗️ ᴊᴏɪɴ ɴᴏᴡ 🎗️" ബട്ടൺ അമർത്തിയ ശേഷം "Request to Join Channel" അമർത്തുക, അതിന് ശേഷം "♻️ ᴛʀʏ ᴀɢᴀɪɴ ♻️" അമർത്തിയാൽ താങ്കൾ ആവശ്യപ്പെട്ട ഫയൽ ലഭിക്കുന്നതാണ്.
    </b>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/TEAM_COLD'>𝚃𝙴𝙰𝙼 𝙲𝙾𝙻𝙳</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : <a href='https://t.me/COLD_X_BOT'>𝗣𝗘𝗧𝗘𝗥 𝗣𝗔𝗥𝗞𝗘𝗥</a>\n‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/COLD_ONEZ'>Ꮯᴏʟᴅ_Ꮻɴᴇᴢ</a>\n‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ\n‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ\n‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\n‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ᴀʟʟ ᴡᴇʙ\n‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ5.2 [sᴛᴀʙʟᴇ]</b></blockquote>"""    
...
"""
    ...
    NO_RESULT_TXT = """<b>ᴛʜɪs ɪs ɴᴏᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ᴀᴅᴅᴇᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ 🙄</b>"""
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>amalabraham@fam</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/cold_Premium_proof'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
...
--------------Verify On Off------------
/verifyoff {{verify.off code}} - off verification <a href="https://t.me/COLD_ONEZ">Cᴏɴᴛᴀᴄᴛ</a> ᴛʜᴇ ʙᴏᴛ ᴀᴅᴍɪɴ ғᴏʀ ᴀ ᴠᴇʀɪғʏ.ᴏғғ ᴄᴏᴅᴇ
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<blockquote><a href="https://t.me/TEAM_COLD">@TEAM_COLD</a></blockquote>
...
Iғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ᴅᴏᴜʙᴛs ᴘʟᴇᴀsᴇ <a href="https://t.me/COLD_ONEZ">ᴄᴏɴᴛᴀᴄᴛ</a> ᴍʏ <a href="https://t.me/COLD_ONEZ">ᴀᴅᴍɪɴ</a></b>"""
